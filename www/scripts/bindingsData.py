...
controls = {
    ...
    #
    'CamTranslateUp': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 1, 'Name': 'GalMap Up', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'CamTranslateDown': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 2, 'Name': 'GalMap Down', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'CamTranslateLeft': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 3, 'Name': 'GalMap Left', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'CamTranslateRight': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 4, 'Name': 'GalMap Right', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'CamTranslateForward': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 5, 'Name': 'GalMap Forward', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'CamTranslateBackward': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 6, 'Name': 'GalMap Backward', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'CamTranslateXAxis': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 7, 'Name': 'GalMap X', 'Type': 'Analogue', 'OverriddenBy': []},
    'CamTranslateYAxis': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 8, 'Name': 'GalMap Y', 'Type': 'Analogue', 'OverriddenBy': []},
    'CamTranslateZAxis': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 9, 'Name': 'GalMap Z', 'Type': 'Analogue', 'OverriddenBy': []},
    'CamTranslateZHold': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 10, 'Name': 'GalMap Z Hold', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'CamPitchAxis': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 11, 'Name': 'GalMap Pitch', 'Type': 'Analogue', 'OverriddenBy': []},
    'CamPitchUp': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 12, 'Name': 'GalMap Pitch Up', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'CamPitchDown': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 13, 'Name': 'GalMap Pitch Down', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'CamYawAxis': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 14, 'Name': 'GalMap Yaw', 'Type': 'Analogue', 'OverriddenBy': []},
    'CamYawLeft': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 15, 'Name': 'GalMap Yaw Left', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'CamYawRight': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 16, 'Name': 'GalMap Yaw Right', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'CamZoomAxis': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 17, 'Name': 'GalMap Zoom', 'Type': 'Analogue', 'OverriddenBy': []},
    'CamZoomIn': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 18, 'Name': 'GalMap Zoom In', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'CamZoomOut': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 19, 'Name': 'GalMap Zoom Out', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},

    #
    # General items available on both ship and SRV
    #
    'RadarRangeAxis': {'Group': 'Misc', 'Category': 'Navigation', 'Order': 1, 'Name': 'Sensor Range', 'Type': 'Analogue', 'OverriddenBy': []},
    'RadarDecreaseRange': {'Group': 'Misc', 'Category': 'Navigation', 'Order': 2, 'Name': 'Dec Sensor Range', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'RadarIncreaseRange': {'Group': 'Misc', 'Category': 'Navigation', 'Order': 3, 'Name': 'Inc Sensor Range', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    ...
    'CommanderCreator_Undo': {'Group': 'Commander creator', 'Category': 'General', 'Order': 10, 'Name': 'Undo', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'CommanderCreator_Redo': {'Group': 'Commander creator', 'Category': 'General', 'Order': 11, 'Name': 'Redo', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'CommanderCreator_Rotation_MouseToggle': {'Group': 'Commander creator', 'Category': 'General', 'Order': 12, 'Name': 'Rotation toggle', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    'GalnetAudio_SkipBackward': {'Group': 'Misc', 'Category': 'General', 'Order': 18, 'Name': 'Prev Audio Track', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    'IncreaseSpeedButtonPartial': {'Group': 'SRV', 'Category': 'Navigation', 'Order': 5, 'Name': 'Inc Speed', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'DecreaseSpeedButtonPartial': {'Group': 'SRV', 'Category': 'Navigation', 'Order': 6, 'Name': 'Dec Speed', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    ...
    'BuggyRollAxisRaw': {'Group': 'SRV', 'Category': 'Navigation', 'Order': 14, 'Name': 'Roll', 'Type': 'Analogue', 'OverriddenBy': ['RollAxisRaw']},
    ...
    'AutoBreakBuggyButton': {'Group': 'SRV', 'Category': 'Navigation', 'Order': 18, 'Name': 'Handbrake', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    'BuggyTurretPitchAxisRaw': {'Group': 'SRV', 'Category': 'Combat', 'Order': 106, 'Name': 'Turret Pitch', 'Type': 'Analogue', 'OverriddenBy': []},
    ...
    'BuggyTurretYawAxisRaw': {'Group': 'SRV', 'Category': 'Combat', 'Order': 110, 'Name': 'Turret Yaw', 'Type': 'Analogue', 'OverriddenBy': []},
    ...
    'BuggyTurretYawRightButton': {'Group': 'SRV', 'Category': 'Combat', 'Order': 112, 'Name': 'Turret Right', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
     ...
     # Managing power
    'ResetPowerDistribution_Buggy': {'Group': 'SRV', 'Category': 'Combat', 'Order': 201, 'Name': 'RST', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['ResetPowerDistribution']},
    'IncreaseEnginesPower_Buggy': {'Group': 'SRV', 'Category': 'Combat', 'Order': 202, 'Name': 'ENG', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['IncreaseEnginesPower']},
    'IncreaseSystemsPower_Buggy': {'Group': 'SRV', 'Category': 'Combat', 'Order': 203, 'Name': 'SYS', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['IncreaseSystemsPower']},
    'IncreaseWeaponsPower_Buggy': {'Group': 'SRV', 'Category': 'Combat', 'Order': 204, 'Name': 'WEP', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['IncreaseWeaponsPower']},

     # Navigation
    'GalaxyMapOpen_Buggy': {'Group': 'SRV', 'Category': 'Navigation', 'Order': 301, 'Name': 'GalMap', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['GalaxyMapOpen']},
    'SystemMapOpen_Buggy': {'Group': 'SRV', 'Category': 'Navigation', 'Order': 302, 'Name': 'SysMap', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['SystemMapOpen']},

     # UI
    'FocusCommsPanel_Buggy': {'Group': 'SRV', 'Order': 401, 'Name': 'Comms Panel', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['FocusCommsPanel']},
    'FocusLeftPanel_Buggy': {'Group': 'SRV', 'Order': 402, 'Name': 'Nav Panel', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['FocusLeftPanel']},
    ...
    'UIFocus_Buggy': {'Group': 'SRV', 'Order': 406, 'Name': 'UI Focus', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['UIFocus']},

     # Misc
    'EjectAllCargo_Buggy': {'Group': 'SRV', 'Order': 501, 'Name': 'Eject All Cargo', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['EjectAllCargo']},
    ...
    'SetSpeed100': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 16, 'Name': '100% Throttle', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'SetSpeed75': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 17, 'Name': '75% Throttle', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'SetSpeed50': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 18, 'Name': '50% Throttle', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'SetSpeed25': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 19, 'Name': '25% Throttle', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'SetSpeedZero': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 20, 'Name': 'All Stop', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'SetSpeedMinus25': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 21, 'Name': '25% Reverse', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'SetSpeedMinus50': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 22, 'Name': '50% Reverse', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'SetSpeedMinus75': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 23, 'Name': '75% Reverse', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'SetSpeedMinus100': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 24, 'Name': '100% Reverse', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'AheadThrust': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 25, 'Name': 'Forward Thrust', 'Type': 'Analogue', 'OverriddenBy': []},
    ...
    'BackwardKey': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 28, 'Name': 'Reverse Thrust', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'BackwardThrustButton': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 29, 'Name': 'Reverse thrust', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    ...
    'ToggleReverseThrottleInput': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 38, 'Name': 'Reverse', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    'PitchAxisAlternate': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 45, 'Name': 'Pitch (Alt)', 'Type': 'Analogue', 'OverriddenBy': ['PitchAxisRaw']},
    'RollAxisAlternate': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 46, 'Name': 'Roll (Alt)', 'Type': 'Analogue', 'OverriddenBy': ['RollAxisRaw']},
    'YawAxisAlternate': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 47, 'Name': 'Yaw (Alt)', 'Type': 'Analogue', 'OverriddenBy': ['YawAxisRaw']},
    'VerticalThrustAlternate': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 48, 'Name': 'Vertical Thrust (Alt)', 'Type': 'Analogue', 'OverriddenBy': ['VerticalThrustRaw']},
    'LateralThrustAlternate': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 49, 'Name': 'Lateral Thrust (Alt)', 'Type': 'Analogue', 'OverriddenBy': ['LateralThrustRaw']},
    ...
    'SelectHighestThreat': {'Group': 'Ship', 'Category': 'Combat', 'Order': 102, 'Name': 'Highest Threat', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'CycleNextTarget': {'Group': 'Ship', 'Category': 'Combat', 'Order': 103, 'Name': 'Next Contact', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'CyclePreviousTarget': {'Group': 'Ship', 'Category': 'Combat', 'Order': 104, 'Name': 'Prev Contact', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'CycleNextHostileTarget': {'Group': 'Ship', 'Category': 'Combat', 'Order': 105, 'Name': 'Next Hostile', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'CyclePreviousHostileTarget': {'Group': 'Ship', 'Category': 'Combat', 'Order': 106, 'Name': 'Prev Hostile', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'DeployHardpointToggle': {'Group': 'Ship', 'Category': 'Combat', 'Order': 107, 'Name': 'Hardpoints', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'PrimaryFire': {'Group': 'Ship', 'Category': 'Combat', 'Order': 108, 'Name': 'Fire 1', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'SecondaryFire': {'Group': 'Ship', 'Category': 'Combat', 'Order': 109, 'Name': 'Fire 2', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'CycleFireGroupNext': {'Group': 'Ship', 'Category': 'Combat', 'Order': 110, 'Name': 'Next Fire Group', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'CycleFireGroupPrevious': {'Group': 'Ship', 'Category': 'Combat', 'Order': 111, 'Name': 'Prev Fire Group', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'CycleNextSubsystem': {'Group': 'Ship', 'Category': 'Combat', 'Order': 112, 'Name': 'Next Subsystem', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'CyclePreviousSubsystem': {'Group': 'Ship', 'Category': 'Combat', 'Order': 113, 'Name': 'Prev Subsystem', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'FireChaffLauncher': {'Group': 'Ship', 'Category': 'Combat', 'Order': 114, 'Name': 'Chaff', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'DeployHeatSink': {'Group': 'Ship', 'Category': 'Combat', 'Order': 116, 'Name': 'Heatsink', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'UseShieldCell': {'Group': 'Ship', 'Category': 'Combat', 'Order': 117, 'Name': 'SCB', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'ChargeECM': {'Group': 'Ship', 'Category': 'Combat', 'Order': 118, 'Name': 'ECM', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},

    # Managing power
    'ResetPowerDistribution': {'Group': 'Ship', 'Category': 'Combat', 'Order': 201, 'Name': 'RST', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'IncreaseEnginesPower': {'Group': 'Ship', 'Category': 'Combat', 'Order': 202, 'Name': 'ENG', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'IncreaseSystemsPower': {'Group': 'Ship', 'Category': 'Combat', 'Order': 203, 'Name': 'SYS', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    'MultiCrewThirdPersonPitchAxisRaw': {'Group': 'Multicrew', 'Category': 'General', 'Order': 281, 'Name': 'Pitch', 'Type': 'Analogue', 'OverriddenBy': ['PitchAxisRaw']},
    ...
    'MultiCrewThirdPersonYawAxisRaw': {'Group': 'Multicrew', 'Category': 'General', 'Order': 284, 'Name': 'Yaw', 'Type': 'Analogue', 'OverriddenBy': ['YawAxisRaw']},
    ...
    'MultiCrewPrimaryFire': {'Group': 'Multicrew', 'Category': 'General', 'Order': 290, 'Name': 'Fire 1', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['PrimaryFire']},
    'MultiCrewSecondaryFire': {'Group': 'Multicrew', 'Category': 'General', 'Order': 292, 'Name': 'Fire 2', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['SecondaryFire']},
    ...
    'TargetNextRouteSystem': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 307, 'Name': 'Next Jump Dest', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},

    # Wings
    'TargetWingman0': {'Group': 'Ship', 'Order': 401, 'Name': 'Wingman 1', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'TargetWingman1': {'Group': 'Ship', 'Order': 402, 'Name': 'Wingman 2', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'TargetWingman2': {'Group': 'Ship', 'Order': 403, 'Name': 'Wingman 3', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'SelectTargetsTarget': {'Group': 'Ship', 'Order': 404, 'Name': 'Wingman\'s target', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'WingNavLock': {'Group': 'Ship', 'Order': 405, 'Name': 'Wingman Navlock', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},

    # UI
    'UIFocus': {'Group': 'Ship', 'Order': 501, 'Name': 'UI Focus', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    'FocusLeftPanel': {'Group': 'Ship', 'Order': 504, 'Name': 'Nav Panel', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    'PitchAxis_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 602, 'Name': 'Pitch (Lndg)', 'Type': 'Analogue', 'OverriddenBy': ['PitchAxisRaw']},
    'PitchUpButton_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 603, 'Name': 'Pitch Up (Lndg)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': ['PitchUpButton']},
    'PitchDownButton_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 604, 'Name': 'Pitch Down (Lndg)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': ['PitchDownButton']},
    'RollAxis_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 605, 'Name': 'Roll (Lndg)', 'Type': 'Analogue', 'OverriddenBy': ['RollAxisRaw']},
    'RollLeftButton_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 606, 'Name': 'Roll Left (Lndg)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': ['RollLeftButton']},
    'RollRightButton_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 607, 'Name': 'Roll Right (Lndg)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': ['RollRightButton']},
    'YawAxis_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 608, 'Name': 'Yaw', 'Type': 'Analogue', 'OverriddenBy': ['YawAxisRaw']},
    'YawLeftButton_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 609, 'Name': 'Yaw Left (Lndg)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': ['YawLeftButton']},
    'YawRightButton_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 610, 'Name': 'Yaw Right (Lndg)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': ['YawRightButton']},
    'AheadThrust_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 611, 'Name': 'Forward Thrust (Lndg)', 'Type': 'Analogue', 'OverriddenBy': ['AheadThrust']},
    'ForwardThrustButton_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 612, 'Name': 'Forward Thrust (Lndg)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': ['ForwardThrustButton']},
    'BackwardThrustButton_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 613, 'Name': 'Reverse Thrust (Lndg)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': ['BackwardThrustButton']},
    'VerticalThrust_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 614, 'Name': 'Vertical Thrust (Lndg)', 'Type': 'Analogue', 'OverriddenBy': ['VerticalThrustRaw']},
    'UpThrustButton_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 615, 'Name': 'Thrust Up (Lndg)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': ['UpThrustButton']},
    'DownThrustButton_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 616, 'Name': 'Thrust Down (Lndg)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': ['DownThrustButton']},
    'LateralThrust_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 617, 'Name': 'Lateral Thrust (Lndg)', 'Type': 'Analogue', 'OverriddenBy': ['LateralThrust']},
    'LeftThrustButton_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 618, 'Name': 'Thrust Left (Lndg)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': ['LeftThrustButton']},
    'RightThrustButton_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 619, 'Name': 'Thrust Right (Lndg)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': ['RightThrustButton']},
    ...
    'ExplorationFSSZoomIn': {'Group': 'Scanners', 'Category': 'General', 'Order': 8, 'Name': 'Zoom FSS In', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'ExplorationFSSZoomOut': {'Group': 'Scanners', 'Category': 'General', 'Order': 9, 'Name': 'Zoom FSS Out', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'ExplorationFSSMiniZoomIn': {'Group': 'Scanners', 'Category': 'General', 'Order': 10, 'Name': 'Step Zoom FSS In', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'ExplorationFSSMiniZoomOut': {'Group': 'Scanners', 'Category': 'General', 'Order': 11, 'Name': 'Step Zoom FSS Out', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    'ExplorationFSSRadioTuningAbsoluteX': {'Group': 'Scanners', 'Category': 'General', 'Order': 15, 'Name': 'FSS Tuning', 'Type': 'Analogue', 'HasAnalogue': False, 'OverriddenBy': []},
    'ExplorationFSSDiscoveryScan': {'Group': 'Scanners', 'Category': 'General', 'Order': 16, 'Name': 'FSS Honk', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'ExplorationFSSQuit': {'Group': 'Scanners', 'Category': 'General', 'Order': 17, 'Name': 'Exit FSS', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'ExplorationFSSTarget': {'Group': 'Scanners', 'Category': 'General', 'Order': 18, 'Name': 'Target FSS', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'ExplorationFSSShowHelp': {'Group': 'Scanners', 'Category': 'General', 'Order': 19, 'Name': 'FSS Help', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'ExplorationSAAChangeScannedAreaViewToggle': {'Group': 'Scanners', 'Category': 'General', 'Order': 20, 'Name': 'Toggle Planet Front/Back', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'ExplorationSAAExitThirdPerson': {'Group': 'Scanners', 'Category': 'General', 'Order': 21, 'Name': 'Exit Surface Scanner', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'SAAThirdPersonPitchAxisRaw': {'Group': 'Scanners', 'Category': 'General', 'Order': 281, 'Name': 'Pitch (DSS)', 'Type': 'Analogue', 'OverriddenBy': ['PitchAxisRaw']},
    'SAAThirdPersonPitchUpButton': {'Group': 'Scanners', 'Category': 'General', 'Order': 282, 'Name': 'Pitch Up (DSS)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'SAAThirdPersonPitchDownButton': {'Group': 'Scanners', 'Category': 'General', 'Order': 283, 'Name': 'Pitch Down (DSS)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'SAAThirdPersonYawAxisRaw': {'Group': 'Scanners', 'Category': 'General', 'Order': 284, 'Name': 'Yaw (DSS)', 'Type': 'Analogue', 'OverriddenBy': ['YawAxisRaw']},
    'SAAThirdPersonYawLeftButton': {'Group': 'Scanners', 'Category': 'General', 'Order': 285, 'Name': 'Yaw Left (DSS)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'SAAThirdPersonYawRightButton': {'Group': 'Scanners', 'Category': 'General', 'Order': 286, 'Name': 'Yaw Right (DSS)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'SAAThirdPersonFovAxisRaw': {'Group': 'Scanners', 'Category': 'General', 'Order': 287, 'Name': 'DSS Field of View', 'Type': 'Analogue', 'OverriddenBy': []},
    'SAAThirdPersonFovOutButton': {'Group': 'Scanners', 'Category': 'General', 'Order': 288, 'Name': 'DSS Field of View Out', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'SAAThirdPersonFovInButton': {'Group': 'Scanners', 'Category': 'General', 'Order': 289, 'Name': 'DSS Field of View In', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},

    # Misc
    'EjectAllCargo': {'Group': 'Ship', 'Category': 'General', 'Order': 701, 'Name': 'Eject All Cargo', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    'ShowPGScoreSummaryInput': {'Group': 'Ship', 'Category': 'General', 'Order': 704, 'Name': 'CQC Score', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    # Camera
    'PhotoCameraToggle': {'Group': 'Camera', 'Category': 'Camera', 'Order': 801, 'Name': 'External Cam', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'PhotoCameraToggle_Buggy': {'Group': 'Camera', 'Category': 'Camera', 'Order': 802, 'Name': 'External Cam', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['PhotoCameraToggle']},
    'ToggleFreeCam': {'Group': 'Camera', 'Category': 'General', 'Order': 803, 'Name': 'Free Cam', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'QuitCamera': {'Group': 'Camera', 'Category': 'General', 'Order': 804, 'Name': 'Exit free Cam', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['ToggleFreeCam']},
    'VanityCameraOne': {'Group': 'Camera', 'Category': 'General', 'Order': 805, 'Name': 'Cam - Cockpit Front', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'VanityCameraTwo': {'Group': 'Camera', 'Category': 'General', 'Order': 806, 'Name': 'Cam - Cockpit Back', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'VanityCameraThree': {'Group': 'Camera', 'Category': 'General', 'Order': 808, 'Name': 'Cam - Commander 1', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'VanityCameraFour': {'Group': 'Camera', 'Category': 'General', 'Order': 808, 'Name': 'Cam - Commander 2', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'VanityCameraFive': {'Group': 'Camera', 'Category': 'General', 'Order': 809, 'Name': 'Cam - Co-Pilot 1', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'VanityCameraSix': {'Group': 'Camera', 'Category': 'General', 'Order': 810, 'Name': 'Cam - Co-Pilot 2', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'VanityCameraSeven': {'Group': 'Camera', 'Category': 'General', 'Order': 811, 'Name': 'Cam - Front', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'VanityCameraEight': {'Group': 'Camera', 'Category': 'General', 'Order': 812, 'Name': 'Cam - Back', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'VanityCameraNine': {'Group': 'Camera', 'Category': 'General', 'Order': 813, 'Name': 'Cam - Low', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'VanityCameraScrollRight': {'Group': 'Camera', 'Category': 'General', 'Order': 814, 'Name': 'Next Cam', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'VanityCameraScrollLeft': {'Group': 'Camera', 'Category': 'General', 'Order': 815, 'Name': 'Prev Cam', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'FreeCamToggleHUD': {'Group': 'Camera', 'Category': 'General', 'Order': 816, 'Name': 'Toggle HUD', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'FreeCamSpeedInc': {'Group': 'Camera', 'Category': 'General', 'Order': 817, 'Name': 'Inc Cam Speed', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'FreeCamSpeedDec': {'Group': 'Camera', 'Category': 'General', 'Order': 818, 'Name': 'Dec Cam Speed', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    'MoveFreeCamX': {'Group': 'Camera', 'Category': 'General', 'Order': 821, 'Name': 'Cam X', 'Type': 'Analogue', 'OverriddenBy': []},
    'MoveFreeCamLeft': {'Group': 'Camera', 'Category': 'General', 'Order': 822, 'Name': 'Cam Left', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'MoveFreeCamRight': {'Group': 'Camera', 'Category': 'General', 'Order': 823, 'Name': 'Cam Right', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'MoveFreeCamY': {'Group': 'Camera', 'Category': 'General', 'Order': 824, 'Name': 'Cam Y', 'Type': 'Analogue', 'OverriddenBy': []},
    'MoveFreeCamUp': {'Group': 'Camera', 'Category': 'General', 'Order': 825, 'Name': 'Cam Up', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'MoveFreeCamDown': {'Group': 'Camera', 'Category': 'General', 'Order': 826, 'Name': 'Cam Down', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'MoveFreeCamZ': {'Group': 'Camera', 'Category': 'General', 'Order': 827, 'Name': 'Cam Z', 'Type': 'Analogue', 'OverriddenBy': []},
    'MoveFreeCamForward': {'Group': 'Camera', 'Category': 'General', 'Order': 828, 'Name': 'Cam Forwards', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'MoveFreeCamBackwards': {'Group': 'Camera', 'Category': 'General', 'Order': 829, 'Name': 'Cam Backwards', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'PitchCamera': {'Group': 'Camera', 'Category': 'General', 'Order': 830, 'Name': 'Cam Pitch', 'Type': 'Analogue', 'OverriddenBy': []},
    'PitchCameraUp': {'Group': 'Camera', 'Category': 'General', 'Order': 831, 'Name': 'Cam Pitch Up', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'PitchCameraDown': {'Group': 'Camera', 'Category': 'General', 'Order': 832, 'Name': 'Cam Pitch Down', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'RollCamera': {'Group': 'Camera', 'Category': 'General', 'Order': 833, 'Name': 'Cam Roll', 'Type': 'Analogue', 'OverriddenBy': []},
    'RollCameraLeft': {'Group': 'Camera', 'Category': 'General', 'Order': 834, 'Name': 'Cam Roll Up', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'RollCameraRight': {'Group': 'Camera', 'Category': 'General', 'Order': 835, 'Name': 'Cam Roll Down', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'YawCamera': {'Group': 'Camera', 'Category': 'General', 'Order': 836, 'Name': 'Cam Yaw', 'Type': 'Analogue', 'OverriddenBy': []},
    'YawCameraLeft': {'Group': 'Camera', 'Category': 'General', 'Order': 837, 'Name': 'Cam Yaw Left', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'YawCameraRight': {'Group': 'Camera', 'Category': 'General', 'Order': 838, 'Name': 'Cam Yaw Right', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'ToggleRotationLock': {'Group': 'Camera', 'Category': 'General', 'Order': 839, 'Name': 'Cam Rotation Lock', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'ToggleReverseThrottleInputFreeCam': {'Group': 'Camera', 'Category': 'General', 'Order': 840, 'Name': 'Cam Reverse', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['ToggleReverseThrottleInput', 'BuggyToggleReverseThrottleInput']},
    ...
    'ToggleAdvanceMode': {'Group': 'Camera', 'Category': 'General', 'Order': 843, 'Name': 'Advanced Cam', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'FStopInc': {'Group': 'Camera', 'Category': 'General', 'Order': 844, 'Name': 'Inc Blur', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'FStopDec': {'Group': 'Camera', 'Category': 'General', 'Order': 845, 'Name': 'Dec Blur', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'FocusDistanceInc': {'Group': 'Camera', 'Category': 'General', 'Order': 846, 'Name': 'Focus Further', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    'FocusDistanceDec': {'Group': 'Camera', 'Category': 'General', 'Order': 847, 'Name': 'Focus Nearer', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
    ...
    'CycleNextPanel': {'Group': 'UI', 'Category': 'UI', 'Order': 5, 'Name': 'Next Panel', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'CyclePreviousPanel': {'Group': 'UI', 'Category': 'UI', 'Order': 6, 'Name': 'Prev Panel', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    'CyclePreviousPage': {'Group': 'UI', 'Category': 'UI', 'Order': 11, 'Name': 'Prev Page', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
}
