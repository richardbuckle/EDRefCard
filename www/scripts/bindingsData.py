...
controls = {
    ...
    'CommanderCreator_Undo': {'Group': 'Holo-Me', 'Category': 'General', 'Order': 10, 'Name': 'Undo', 'Type': 'Digital', 'HasAnalogue': False, 'HideIfSameAs': []},
    'CommanderCreator_Redo': {'Group': 'Holo-Me', 'Category': 'General', 'Order': 11, 'Name': 'Redo', 'Type': 'Digital', 'HasAnalogue': False, 'HideIfSameAs': []},
    'CommanderCreator_Rotation_MouseToggle': {'Group': 'Holo-Me', 'Category': 'General', 'Order': 12, 'Name': 'Rotation toggle', 'Type': 'Digital', 'HasAnalogue': False, 'HideIfSameAs': []},
    'CommanderCreator_Rotation': {'Group': 'Holo-Me', 'Category': 'General', 'Order': 13, 'Name': 'Rotation', 'Type': 'Digital', 'HideIfSameAs': []},
