...
controls = {
    ...
    'BuggyTurretYawRightButton': {'Group': 'SRV', 'Category': 'Combat', 'Order': 112, 'Name': 'Turret Right', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': []},
     ...
     # Managing power
    'ResetPowerDistribution_Buggy': {'Group': 'SRV', 'Category': 'Combat', 'Order': 201, 'Name': 'Pips RST', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['ResetPowerDistribution']},
    'IncreaseEnginesPower_Buggy': {'Group': 'SRV', 'Category': 'Combat', 'Order': 202, 'Name': 'Pips to ENG', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['IncreaseEnginesPower']},
    'IncreaseSystemsPower_Buggy': {'Group': 'SRV', 'Category': 'Combat', 'Order': 203, 'Name': 'Pips to SYS', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['IncreaseSystemsPower']},
    'IncreaseWeaponsPower_Buggy': {'Group': 'SRV', 'Category': 'Combat', 'Order': 204, 'Name': 'Pips to WEP', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['IncreaseWeaponsPower']},
    ...
    'CyclePreviousTarget': {'Group': 'Ship', 'Category': 'Combat', 'Order': 104, 'Name': 'Target Prev', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    'CyclePreviousHostileTarget': {'Group': 'Ship', 'Category': 'Combat', 'Order': 106, 'Name': 'Target Prev Hostile', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'DeployHardpointToggle': {'Group': 'Ship', 'Category': 'Combat', 'Order': 107, 'Name': 'Hardpoints', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'PrimaryFire': {'Group': 'Ship', 'Category': 'Combat', 'Order': 108, 'Name': 'Primary Fire', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'SecondaryFire': {'Group': 'Ship', 'Category': 'Combat', 'Order': 109, 'Name': 'Secondary Fire', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    # Managing power
    'ResetPowerDistribution': {'Group': 'Ship', 'Category': 'Combat', 'Order': 201, 'Name': 'Pips RST', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'IncreaseEnginesPower': {'Group': 'Ship', 'Category': 'Combat', 'Order': 202, 'Name': 'Pips to ENG', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'IncreaseSystemsPower': {'Group': 'Ship', 'Category': 'Combat', 'Order': 203, 'Name': 'Pips to SYS', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'IncreaseWeaponsPower': {'Group': 'Ship', 'Category': 'Combat', 'Order': 204, 'Name': 'Pips to WEP', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    'MultiCrewPrimaryFire': {'Group': 'Multicrew', 'Category': 'General', 'Order': 290, 'Name': 'Primary Fire', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['PrimaryFire']},
    'MultiCrewSecondaryFire': {'Group': 'Multicrew', 'Category': 'General', 'Order': 292, 'Name': 'Secondary Fire', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['SecondaryFire']},
    ...
    'VanityCameraScrollLeft': {'Group': 'Camera', 'Category': 'General', 'Order': 815, 'Name': 'Prev Camera', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    'ToggleRotationLock': {'Group': 'Camera', 'Category': 'General', 'Order': 839, 'Name': 'Camera Rotation Lock', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    'ToggleReverseThrottleInputFreeCam': {'Group': 'Camera', 'Category': 'General', 'Order': 840, 'Name': 'Camera Reverse', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': ['ToggleReverseThrottleInput', 'BuggyToggleReverseThrottleInput']},
    ...
    'ToggleAdvanceMode': {'Group': 'Camera', 'Category': 'General', 'Order': 843, 'Name': 'Advanced Mode', 'Type': 'Digital', 'HasAnalogue': False, 'OverriddenBy': []},
    ...
    'FocusDistanceInc': {'Group': 'Camera', 'Category': 'General', 'Order': 846, 'Name': 'Inc Focus Distance', 'Type': 'Digital', 'HasAnalouge': True, 'OverriddenBy': []},
    'FocusDistanceDec': {'Group': 'Camera', 'Category': 'General', 'Order': 847, 'Name': 'Dec Focus Distance', 'Type': 'Digital', 'HasAnalouge': True, 'OverriddenBy': []},
...
keymap = {
    ...
    'Key_Numpad_Equals': 'Numpad =',
    'Key_Numpad_Comma': 'Numpad ,',
    'Key_PageDown': 'PgDn',
    'Key_PageUp': 'PgUp',
    'Key_Grave': '`',
    'Key_BackSlash': '\\',
