...
controls = {
    ...
    'AheadThrust_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 611, 'Name': 'Forward Thrust (Landing)', 'Type': 'Analogue', 'OverriddenBy': ['AheadThrust']},
    ...
    'BackwardThrustButton_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 613, 'Name': 'Reverse Thrust (Landing)', 'Type': 'Digital', 'HasAnalogue': True, 'OverriddenBy': ['BackwardThrustButton']},
