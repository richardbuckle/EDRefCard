...
controls = {
    ...
    'CamPitchAxis': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 11, 'Name': 'GalMap Pitch', 'Type': 'Analogue', 'HideIfSameAs': []},
    'CamPitchUp': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 12, 'Name': 'GalMap Pitch Up', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'CamPitchDown': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 13, 'Name': 'GalMap Pitch Down', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'CamYawAxis': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 14, 'Name': 'GalMap Yaw', 'Type': 'Analogue', 'HideIfSameAs': []},
    'CamYawLeft': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 15, 'Name': 'GalMap Yaw Left', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'CamYawRight': {'Group': 'Galaxy map', 'Category': 'UI', 'Order': 16, 'Name': 'GalMap Yaw Right', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    ...
    'CommanderCreator_Undo': {'Group': 'Commander creator', 'Category': 'General', 'Order': 10, 'Name': 'Undo', 'Type': 'Digital', 'HasAnalogue': False, 'HideIfSameAs': []},
    'CommanderCreator_Redo': {'Group': 'Commander creator', 'Category': 'General', 'Order': 11, 'Name': 'Redo', 'Type': 'Digital', 'HasAnalogue': False, 'HideIfSameAs': []},
    'CommanderCreator_Rotation_MouseToggle': {'Group': 'Commander creator', 'Category': 'General', 'Order': 12, 'Name': 'Rotation toggle', 'Type': 'Digital', 'HasAnalogue': False, 'HideIfSameAs': []},
    'CommanderCreator_Rotation': {'Group': 'Commander creator', 'Category': 'General', 'Order': 13, 'Name': 'Rotation', 'Type': 'Digital', 'HideIfSameAs': []},
    ...
    #
    # Driving
    'SteeringAxis': {'Group': 'SRV', 'Category': 'Navigation', 'Order': 1, 'Name': 'Steering', 'Type': 'Analogue', 'HideIfSameAs': []},
    'SteerLeftButton': {'Group': 'SRV', 'Category': 'Navigation', 'Order': 2, 'Name': 'Steer Left', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'SteerRightButton': {'Group': 'SRV', 'Category': 'Navigation', 'Order': 3, 'Name': 'Steer Right', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'DriveSpeedAxis': {'Group': 'SRV', 'Category': 'Navigation', 'Order': 4, 'Name': 'Speed', 'Type': 'Analogue', 'HideIfSameAs': []},
    ...
    'IncreaseSpeedButtonMax': {'Group': 'SRV', 'Category': 'Navigation', 'Order': 7, 'Name': 'Maximum Speed', 'Type': 'Digital', 'HasAnalogue': False, 'HideIfSameAs': []},
    'DecreaseSpeedButtonMax': {'Group': 'SRV', 'Category': 'Navigation', 'Order': 8, 'Name': 'Zero Speed', 'Type': 'Digital', 'HasAnalogue': False, 'HideIfSameAs': []},
    ...
    'BuggyTurretPitchAxisRaw': {'Group': 'SRV', 'Category': 'Combat', 'Order': 106, 'Name': 'Turret Pitch', 'Type': 'Analogue', 'HideIfSameAs': []},
    'BuggyTurretPitchDownButton': {'Group': 'SRV', 'Category': 'Combat', 'Order': 107, 'Name': 'Turret Down', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'BuggyTurretPitchUpButton': {'Group': 'SRV', 'Category': 'Combat', 'Order': 108, 'Name': 'Turret Up', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'BuggyTurretYawAxisRaw': {'Group': 'SRV', 'Category': 'Combat', 'Order': 110, 'Name': 'Turret Yaw', 'Type': 'Analogue', 'HideIfSameAs': []},
    'BuggyTurretYawLeftButton': {'Group': 'SRV', 'Category': 'Combat', 'Order': 111, 'Name': 'Turret Left', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'BuggyTurretYawRightButton': {'Group': 'SRV', 'Category': 'Combat', 'Order': 112, 'Name': 'Turret Right', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    ...
    'LateralThrust': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 34, 'Name': 'Lateral Thrust', 'Type': 'Analogue', 'HideIfSameAs': []},
    ...
    'MultiCrewThirdPersonPitchUpButton': {'Group': 'Multicrew', 'Category': 'General', 'Order': 282, 'Name': 'Pitch Up', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'MultiCrewThirdPersonPitchDownButton': {'Group': 'Multicrew', 'Category': 'General', 'Order': 283, 'Name': 'Pitch Down', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'MultiCrewThirdPersonYawAxisRaw': {'Group': 'Multicrew', 'Category': 'General', 'Order': 284, 'Name': 'Yaw', 'Type': 'Analogue', 'HideIfSameAs': ['YawAxisRaw']},
    'MultiCrewThirdPersonYawLeftButton': {'Group': 'Multicrew', 'Category': 'General', 'Order': 285, 'Name': 'Yaw Left', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'MultiCrewThirdPersonYawRightButton': {'Group': 'Multicrew', 'Category': 'General', 'Order': 286, 'Name': 'Yaw Right', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    ...
    'MultiCrewCockpitUICycleForward': {'Group': 'Multicrew', 'Category': 'General', 'Order': 294, 'Name': 'UI Forward', 'Type': 'Digital', 'HasAnalogue': False, 'HideIfSameAs': ['UI_Up', 'UI_Down']},
    'MultiCrewCockpitUICycleBackward': {'Group': 'Multicrew', 'Category': 'General', 'Order': 295, 'Name': 'UI Backward', 'Type': 'Digital', 'HasAnalogue': False, 'HideIfSameAs': ['UI_Up', 'UI_Down']},
    ...
    'LateralThrust_Landing': {'Group': 'Ship', 'Category': 'Navigation', 'Order': 617, 'Name': 'Lateral Thrust (Lndg)', 'Type': 'Analogue', 'HideIfSameAs': ['LateralThrust']},
    ...
    'ExplorationFSSCameraPitch': {'Group': 'Scanners', 'Category': 'General', 'Order': 2, 'Name': 'Pitch (FSS)', 'Type': 'Analogue', 'HasAnalogue': False, 'HideIfSameAs': []},
    'ExplorationFSSCameraPitchIncreaseButton': {'Group': 'Scanners', 'Category': 'General', 'Order': 3, 'Name': 'Pitch Up (FSS)', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'ExplorationFSSCameraPitchDecreaseButton': {'Group': 'Scanners', 'Category': 'General', 'Order': 4, 'Name': 'Pitch Down (FSS)', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'ExplorationFSSCameraYaw': {'Group': 'Scanners', 'Category': 'General', 'Order': 5, 'Name': 'Yaw (FSS)', 'Type': 'Analogue', 'HasAnalogue': False, 'HideIfSameAs': []},
    'ExplorationFSSCameraYawIncreaseButton': {'Group': 'Scanners', 'Category': 'General', 'Order': 6, 'Name': 'Yaw Right (FSS)', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'ExplorationFSSCameraYawDecreaseButton': {'Group': 'Scanners', 'Category': 'General', 'Order': 7, 'Name': 'Yaw Left (FSS)', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    ...
    'ExplorationSAAExitThirdPerson': {'Group': 'Scanners', 'Category': 'General', 'Order': 21, 'Name': 'Exit Surface Scanner', 'Type': 'Digital', 'HasAnalogue': False, 'HideIfSameAs': []},
    ...
    'SAAThirdPersonPitchUpButton': {'Group': 'Scanners', 'Category': 'General', 'Order': 282, 'Name': 'Pitch Up (DSS)', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'SAAThirdPersonPitchDownButton': {'Group': 'Scanners', 'Category': 'General', 'Order': 283, 'Name': 'Pitch Down (DSS)', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'SAAThirdPersonYawAxisRaw': {'Group': 'Scanners', 'Category': 'General', 'Order': 284, 'Name': 'Yaw (DSS)', 'Type': 'Analogue', 'HideIfSameAs': ['YawAxisRaw']},
    'SAAThirdPersonYawLeftButton': {'Group': 'Scanners', 'Category': 'General', 'Order': 285, 'Name': 'Yaw Left (DSS)', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'SAAThirdPersonYawRightButton': {'Group': 'Scanners', 'Category': 'General', 'Order': 286, 'Name': 'Yaw Right (DSS)', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    ...
    'PitchCamera': {'Group': 'Camera', 'Category': 'General', 'Order': 830, 'Name': 'Cam Pitch', 'Type': 'Analogue', 'HideIfSameAs': []},
    'PitchCameraUp': {'Group': 'Camera', 'Category': 'General', 'Order': 831, 'Name': 'Cam Pitch Up', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'PitchCameraDown': {'Group': 'Camera', 'Category': 'General', 'Order': 832, 'Name': 'Cam Pitch Down', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'RollCamera': {'Group': 'Camera', 'Category': 'General', 'Order': 833, 'Name': 'Cam Roll', 'Type': 'Analogue', 'HideIfSameAs': []},
    'RollCameraLeft': {'Group': 'Camera', 'Category': 'General', 'Order': 834, 'Name': 'Cam Roll Up', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'RollCameraRight': {'Group': 'Camera', 'Category': 'General', 'Order': 835, 'Name': 'Cam Roll Down', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'YawCamera': {'Group': 'Camera', 'Category': 'General', 'Order': 836, 'Name': 'Cam Yaw', 'Type': 'Analogue', 'HideIfSameAs': []},
    'YawCameraLeft': {'Group': 'Camera', 'Category': 'General', 'Order': 837, 'Name': 'Cam Yaw Left', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
    'YawCameraRight': {'Group': 'Camera', 'Category': 'General', 'Order': 838, 'Name': 'Cam Yaw Right', 'Type': 'Digital', 'HasAnalogue': True, 'HideIfSameAs': []},
